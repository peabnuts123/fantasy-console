 ...
 * @param {string} path
 */
function pathToPublicImport(path) {
  let pathSegments = path
    // Strip file extension
    .replace(/\.\w+$/, '')
    // Strip any trailing 'index' names
